...
//txtRegistro txtNomeRegistro txtSenhaRegistro
$msg = "";


if(filter_input(INPUT_POST, "msg", FILTER_SANITIZE_STRING)) {
    if(filter_input(INPUT_POST, "msg", FILTER_SANITIZE_STRING == 1)) {
